  ...
  return (
    <section className="relative w-full pt-32 pb-20 px-6 lg:px-12 flex flex-col items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <Link 
          to="/register" 
          className="bg-primary-fixed text-on-primary-fixed px-8 py-4 rounded-full font-label-bold text-sm uppercase tracking-widest hover:bg-white transition-all duration-300 shadow-[0_0_20px_rgba(150,252,48,0.3)] hover:shadow-[0_0_30px_rgba(150,252,48,0.5)] active:scale-95"
        >
          Start Free Trial
        </Link>
      </div>
